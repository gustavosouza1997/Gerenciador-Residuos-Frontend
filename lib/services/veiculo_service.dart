...
class VeiculoService {
  ...
  Future<Map<String, dynamic>> createVeiculo(Map<String, dynamic> veiculoData) async {
  ...
  Future<Map<String, dynamic>> getAllVeiculo() async {
    ...
    final response = await http.get(
      Uri.parse('$apiUrl/api/veiculo/listar'),
      headers: headers
    );
  ...
  Future<Map<String, dynamic>> updateVeiculo(String id, Map<String, dynamic> updatedData) async {
    final headers = await _getHeaders();
